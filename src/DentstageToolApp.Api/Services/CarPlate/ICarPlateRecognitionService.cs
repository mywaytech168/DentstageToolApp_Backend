...
/// </summary>
public interface ICarPlateRecognitionService
{
    /// <summary>
    ...
    Task<CarPlateRecognitionResponse?> RecognizeAsync(CarPlateImageSource imageSource, CancellationToken cancellationToken);
    ...
    Task<CarPlateMaintenanceHistoryResponse> GetMaintenanceHistoryAsync(string licensePlate, CancellationToken cancellationToken);
}
